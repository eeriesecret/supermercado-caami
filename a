...
<main>
    ...
    <h4>Nuestros valores son el pilar de nuestra empresa: nos comprometemos a ofrecer productos de alta calidad, tanto frescos como de marcas reconocidas, poniendo siempre al cliente en primer lugar y trabajando para superar sus expectativas. Innovamos constantemente en nuestros procesos y servicios, brindando una experiencia moderna y eficiente, al mismo tiempo que promovemos prácticas sostenibles y apoyamos a los productores locales. Valoramos profundamente a nuestros empleados, fomentando un ambiente de trabajo colaborativo, y mantenemos un fuerte compromiso con la transparencia y la integridad en todas nuestras operaciones.</h4>
